    ...
    <body>
        ...
        <div id="edit-article" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.article}" method="PUT">
                ...
                <fieldset class="form">
                    <f:field bean="article" property="title">
                        <g:textField name="${article.title}" value="${this.article.title}" />
                    </f:field>
                    <f:field bean="article" property="body">
                        <g:textField name="${article.body}" value="${this.article.body}" />
                    </f:field>
                </fieldset>
